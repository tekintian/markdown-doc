...
(function(global) {
    ...
    function mixin(e, t, n, r) {
        return t && eachProp(t, function(t, i) {
            if (n || !hasProp(e, i)) r && typeof t == "object" && t && !isArray(t) && !isFunction(t) && !(t instanceof RegExp) ? (e[i] || (e[i] = {}), 
    ...
    function newContext(e) {
        ...
        function g(e, t, n) {
            ...
            e && e.charAt(0) === "." && (t ? (g = v.slice(0, v.length - 1), e = e.split("/"), 
            l = e.length - 1, o.nodeIdCompat && jsSuffixRegExp.test(e[l]) && (e[l] = e[l].replace(jsSuffixRegExp, "")), 
            e = g.concat(e), m(e), e = e.join("/")) :e.indexOf("./") === 0 && (e = e.substring(2)));
            if (n && y && (v || b)) {
                s = e.split("/");
        ...
        function b(e) {
            ...
            if (t && isArray(t) && t.length > 1) return t.shift(), r.require.undef(e), r.require([ e ]), 
            !0;
        }
        function w(e) {
        ...
        function E(e, t, n, i) {
            ...
            return e || (p = !1, e = "_@r" + (d += 1)), a = w(e), f = a[0], e = a[1], f && (f = g(f, l, i), 
            o = getOwn(c, f)), e && (f ? o && o.normalize ? m = o.normalize(e, function(e) {
                return g(e, l, i);
        ...
        function L() {
            ...
            e.contextName = r.contextName, T(e);
            h && each(l, function(e) {
                k(e, {}, {});
        ...
        return i = {
            ...
            this.events = getOwn(f, e.id) || {}, this.map = e, this.shim = getOwn(o.shim, e.id), 
                ...
                if (!this.inited) this.fetch(); else if (this.error) this.emit("error", this.error); else if (!this.defining) {
                    ...
                    if (this.depCount < 1 && !this.defined) {
                        if (isFunction(o)) {
                            ...
                            if (e) return e.requireMap = this.map, e.requireModules = this.map.isDefine ? [ this.map.id ] :null, 
                            e.requireType = this.map.isDefine ? "define" :"require", T(this.error = e);
                        } else s = o;
                        this.exports = s, this.map.isDefine && !this.ignore && (c[n] = s, req.onResourceLoad && req.onResourceLoad(r, this.map, this.depMaps)), 
                        C(n), this.defined = !0;
                    }
            ...
            enable:function() {
                a[this.map.id] = this, this.enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function(e, t) {
                    var n, s, o;
                    if (typeof e == "string") {
                        e = E(e, this.map.isDefine ? this.map :this.map.parentMap, !1, !this.skipMap), this.depMaps[t] = e, 
                        o = getOwn(i, e.id);
                        if (o) {
            ...
            makeRequire:function(t, n) {
                function s(o, a, f) {
                    ...
                    l = h.id, hasProp(c, l) ? c[l] :T(makeError("notloaded", 'Module name "' + l + '" has not been loaded yet for context: ' + e + (t ? "" :". Use require([])")))) :(_(), 
                    r.nextTick(function() {
    ...
    req = requirejs = function(e, t, n, r) {
        ...
        return !isArray(e) && typeof e != "string" && (s = e, isArray(t) ? (e = t, t = n, 
        n = r) :e = []), s && s.context && (o = s.context), i = getOwn(contexts, o), i || (i = contexts[o] = req.s.newContext(o)), 
        s && i.configure(s), i.require(e, t, n);
    ...
    req.createNode = function(e, t, n) {
        ...
        var r = e && e.config || {}, i;
        if (isBrowser) return i = req.createNode(r, t, n), i.setAttribute("data-requirecontext", e.contextName), 
        i.setAttribute("data-requiremodule", t), i.attachEvent && !(i.attachEvent.toString && i.attachEvent.toString().indexOf("[native code") < 0) && !isOpera ? (useInteractive = !0, 
        i.attachEvent("onreadystatechange", e.onScriptLoad)) :(i.addEventListener("load", e.onScriptLoad, !1), 
        i.addEventListener("error", e.onScriptError, !1)), i.src = n, currentlyAddingScript = i, 
        ...
        if (dataMain) return mainScript = dataMain, cfg.baseUrl || (src = mainScript.split("/"), 
        ...
        var r, i;
        typeof e != "string" && (n = t, t = e, e = null), isArray(t) || (n = t, t = null), 
    ...
    function defaultDisplay(e) {
        ...
        if (!n) {
            ...
            t = iframe[0].contentDocument, t.write(), t.close(), n = actualDisplay(e, t), iframe.detach();
            elemdisplay[e] = n;
        }
        return n;
    }
    function curCSS(e, t, n) {
        ...
        return n = n || getStyles(e), n && (o = n.getPropertyValue(t) || n[t]), n && (o === "" && !jQuery.contains(e.ownerDocument, e) && (o = jQuery.style(e, t)), 
        rnumnonpx.test(o) && rmargin.test(t) && (r = u.width, i = u.minWidth, s = u.maxWidth, 
        u.minWidth = u.maxWidth = u.width = o, o = n.width, u.width = r, u.minWidth = i, 
        u.maxWidth = s)), o !== undefined ? o + "" :o;
    }
    ...
    function augmentWidthOrHeight(e, t, n, r, i) {
        ...
        r ? (n === "content" && (o -= jQuery.css(e, "padding" + cssExpand[s], !0, i)), n !== "margin" && (o -= jQuery.css(e, "border" + cssExpand[s] + "Width", !0, i))) :(o += jQuery.css(e, "padding" + cssExpand[s], !0, i), 
    ...
    function showHide(e, t) {
        ...
        for (;o < u; o++) {
            r = e[o];
            if (!r.style) continue;
            s[o] = data_priv.get(r, "olddisplay"), n = r.style.display, t ? (!s[o] && n === "none" && (r.style.display = ""), 
    ...
    function defaultPrefilter(e, t, n) {
        ...
        n.queue || (u = jQuery._queueHooks(e, "fx"), u.unqueued == null && (u.unqueued = 0, 
        ...
        f = jQuery.css(e, "display"), l = f === "none" ? data_priv.get(e, "olddisplay") || defaultDisplay(e.nodeName) :f, 
        ...
        if (!jQuery.isEmptyObject(h)) {
            v ? "hidden" in v && (d = v.hidden) :v = data_priv.access(e, "fxshow", {}), s && (v.hidden = !d), 
            ...
            for (r in h) o = createTween(d ? v[r] :0, r, c), r in v || (v[r] = o.start, d && (o.end = o.start, 
    ...
    function propFilter(e, t) {
        var n, r, i, s, o;
        for (n in e) {
            r = jQuery.camelCase(n), i = t[r], s = e[n], jQuery.isArray(s) && (i = s[1], s = e[n] = s[0]), 
            n !== r && (e[r] = s, delete e[n]), o = jQuery.cssHooks[r];
            if (o && "expand" in o) {
    ...
    function Animation(e, t, n) {
        ...
        return jQuery.map(l, createTween, f), jQuery.isFunction(f.opts.start) && f.opts.start.call(e, f), 
    ...
    function addToPrefiltersOrTransports(e) {
        return function(t, n) {
            ...
            if (jQuery.isFunction(n)) while (r = s[i++]) r[0] === "+" ? (r = r.slice(1) || "*", 
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        typeof o == "boolean" && (f = o, o = arguments[u] || {}, u++), typeof o != "object" && !jQuery.isFunction(o) && (o = {}), 
        u === a && (o = this, u--);
        ...
        globalEval:function(code) {
            ...
            code = jQuery.trim(code), code && (code.indexOf("use strict") === 1 ? (script = document.createElement("script"), 
        ...
        map:function(e, t, n) {
            ...
            if (o) for (;i < s; i++) r = t(e[i], i, n), r != null && u.push(r); else for (i in e) r = t(e[i], i, n), 
            r != null && u.push(r);
        ...
        proxy:function(e, t) {
            var n, r, i;
            return typeof t == "string" && (n = e[t], t = e, e = n), jQuery.isFunction(e) ? (r = slice.call(arguments, 2), 
            i = function() {
    ...
    var Sizzle = function(e) {
        function st(e, t, r, i) {
            ...
            if (v && !i) {
                if (s = Z.exec(e)) if (f = s[1]) {
                    ...
                    if ((f = s[3]) && n.getElementsByClassName && t.getElementsByClassName) return P.apply(r, t.getElementsByClassName(f)), 
                    r;
                }
                if (n.qsa && (!m || !m.test(e))) {
                    y = g = w, S = t, x = l === 9 && e;
                    if (l === 1 && t.nodeName.toLowerCase() !== "object") {
                        d = o(e), (g = t.getAttribute("id")) ? y = g.replace(tt, "\\$&") :t.setAttribute("id", y), 
                        y = "[id='" + y + "'] ", c = d.length;
        ...
        n = st.support = {}, s = st.isXML = function(e) {
            ...
            if (n.qsa = Y.test(i.querySelectorAll)) at(function(e) {
                e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && m.push("[*^$]=" + F + "*(?:''|\"\")"), 
            ...
            t = Y.test(d.compareDocumentPosition), b = t || Y.test(d.contains) ? function(e, t) {
            ...
            preFilter:{
                ATTR:function(e) {
                    return e[1] = e[1].replace(nt, rt), e[3] = (e[3] || e[4] || e[5] || "").replace(nt, rt), 
                    e[2] === "~=" && (e[3] = " " + e[3] + " "), e.slice(0, 4);
                },
                CHILD:function(e) {
                    return e[1] = e[1].toLowerCase(), e[1].slice(0, 3) === "nth" ? (e[3] || st.error(e[0]), 
                    e[4] = +(e[4] ? e[5] + (e[6] || 1) :2 * (e[3] === "even" || e[3] === "odd")), e[5] = +(e[7] + e[8] || e[3] === "odd")) :e[3] && st.error(e[0]), 
                    e;
                },
                PSEUDO:function(e) {
                    var t, n = !e[6] && e[2];
                ...
                CHILD:function(e, t, n, r, i) {
                    ...
                    return r === 1 && i === 0 ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (o && y) {
                                l = m[w] || (m[w] = {}), f = l[e] || [], p = f[0] === S && f[1], h = f[0] === S && f[2], 
                                c = p && m.childNodes[p];
            ...
            pseudos:{
                ...
                lang:ut(function(e) {
                    ...
                    function(t) {
                        var n;
                        do if (n = v ? t.lang :t.getAttribute("xml:lang") || t.getAttribute("lang")) return n = n.toLowerCase(), 
                        n === e || n.indexOf(e + "-") === 0; while ((t = t.parentNode) && t.nodeType === 1);
                        return !1;
                    };
                }),
                target:function(t) {
        ...
        return vt.prototype = r.filters = r.pseudos, r.setFilters = new vt(), o = st.tokenize = function(e, t) {
            ...
            while (u) {
                ...
                for (o in r.filter) (i = K[o].exec(u)) && (!f[o] || (i = f[o](i))) && (n = i.shift(), 
                s.push({
                    value:n,
                    type:o,
                    matches:i
        ...
        }, n.sortStable = w.split("").sort(k).join("") === w, n.detectDuplicates = !!c, 
        h(), n.sortDetached = at(function(e) {
    ...
    jQuery.filter = function(e, t, n) {
        ...
        find:function(e) {
            ...
            return r = this.pushStack(n > 1 ? jQuery.unique(r) :r), r.selector = this.selector ? this.selector + " " + e :e, 
            r;
        },
        filter:function(e) {
    ...
    var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, init = jQuery.fn.init = function(e, t) {
        ...
        if (typeof e == "string") {
            ...
            if (n && (n[1] || !t)) {
                ...
                return r = document.getElementById(n[2]), r && r.parentNode && (this.length = 1, 
                this[0] = r), this.context = document, this.selector = e, this;
            }
            return !t || t.jquery ? (t || rootjQuery).find(e) :this.constructor(t).find(e);
        }
        return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) :jQuery.isFunction(e) ? typeof rootjQuery.ready != "undefined" ? rootjQuery.ready(e) :e(jQuery) :(e.selector !== undefined && (this.selector = e.selector, 
        this.context = e.context), jQuery.makeArray(e, this));
    };
    ...
    jQuery.extend({
        ...
        jQuery.fn[e] = function(n, r) {
            ...
            return e.slice(-5) !== "Until" && (r = n), r && typeof r == "string" && (i = jQuery.filter(r, i)), 
        ...
        var t, n, r, i, s, o, u = [], a = !e.once && [], f = function(c) {
            ...
            remove:function() {
                return u && jQuery.each(arguments, function(e, t) {
                    var n;
                    while ((n = jQuery.inArray(t, u, n)) > -1) u.splice(n, 1), r && (n <= s && s--, 
                    n <= o && o--);
                }), this;
            },
            has:function(e) {
    ...
    jQuery.fn.ready = function(e) {
        ...
        ready:function(e) {
            ...
            readyList.resolveWith(document, [ jQuery ]), jQuery.fn.triggerHandler && (jQuery(document).triggerHandler("ready"), 
            jQuery(document).off("ready"));
        }
    }), jQuery.ready.promise = function(e) {
        return readyList || (readyList = jQuery.Deferred(), document.readyState === "complete" ? setTimeout(jQuery.ready) :(document.addEventListener("DOMContentLoaded", completed, !1), 
        window.addEventListener("load", completed, !1))), readyList.promise(e);
    ...
    var access = jQuery.access = function(e, t, n, r, i, s, o) {
        ...
        if (jQuery.type(n) === "object") {
            ...
            i = !0, jQuery.isFunction(r) || (o = !0), f && (o ? (t.call(e, r), t = null) :(f = t, 
            t = function(e, t, n) {
    ...
    jQuery.acceptData = function(e) {
        ...
        access:function(e, t, n) {
            ...
            r !== undefined ? r :this.get(e, jQuery.camelCase(t))) :(this.set(e, t, n), n !== undefined ? n :t);
        },
        remove:function(e, t) {
            ...
            if (t === undefined) this.cache[s] = {}; else {
                ...
                t in o ? r = [ t, i ] :(r = i, r = r in o ? [ r ] :r.match(rnotwhite) || [])), n = r.length;
    ...
    jQuery.extend({
            ...
            if (e === undefined) {
                if (this.length) {
                    ...
                    if (s.nodeType === 1 && !data_priv.get(s, "hasDataAttrs")) {
                        n = o.length;
                        while (n--) o[n] && (r = o[n].name, r.indexOf("data-") === 0 && (r = jQuery.camelCase(r.slice(5)), 
                        dataAttr(s, r, i[r])));
        ...
        queue:function(e, t, n) {
            var r;
            if (e) return t = (t || "fx") + "queue", r = data_priv.get(e, t), n && (!r || jQuery.isArray(n) ? r = data_priv.access(e, t, jQuery.makeArray(n)) :r.push(n)), 
            r || [];
        },
    ...
    (function() {
        ...
        t.appendChild(n), support.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, 
        t.innerHTML = "<textarea>x</textarea>", support.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue;
    })();
    ...
    jQuery.event = {
        ...
        add:function(e, t, n, r, i) {
            ...
            if (!m) return;
            n.handler && (s = n, n = s.handler, i = s.selector), n.guid || (n.guid = jQuery.guid++), 
            (a = m.events) || (a = m.events = {}), (o = m.handle) || (o = m.handle = function(t) {
            ...
            while (f--) {
                ...
                if (!p) continue;
                c = jQuery.event.special[p] || {}, p = (i ? c.delegateType :c.bindType) || p, c = jQuery.event.special[p] || {}, 
                l = jQuery.extend({
                    type:p,
                    origType:v,
                    data:r,
                    ...
                    namespace:d.join(".")
                }, s), (h = a[p]) || (h = a[p] = [], h.delegateCount = 0, (!c.setup || c.setup.call(e, r, d, o) === !1) && e.addEventListener && e.addEventListener(p, o, !1)), 
                c.add && (c.add.call(e, l), l.handler.guid || (l.handler.guid = n.guid)), i ? h.splice(h.delegateCount++, 0, l) :h.push(l), 
        ...
        remove:function(e, t, n, r, i) {
            ...
            while (f--) {
                ...
                c = jQuery.event.special[p] || {}, p = (r ? c.delegateType :c.bindType) || p, h = a[p] || [], 
                u = u[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = h.length;
                while (s--) l = h[s], (i || v === l.origType) && (!n || n.guid === l.guid) && (!u || u.test(l.namespace)) && (!r || r === l.selector || r === "**" && l.selector) && (h.splice(s, 1), 
                l.selector && h.delegateCount--, c.remove && c.remove.call(e, l));
        ...
        trigger:function(e, t, n, r) {
            ...
            h.indexOf(".") >= 0 && (p = h.split("."), h = p.shift(), p.sort()), a = h.indexOf(":") < 0 && "on" + h, 
            e = e[jQuery.expando] ? e :new jQuery.Event(h, typeof e == "object" && e), e.isTrigger = r ? 2 :3, 
            e.namespace = p.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") :null, 
            e.result = undefined, e.target || (e.target = n), t = t == null ? [ e ] :jQuery.makeArray(t, [ e ]), 
            ...
            f = (data_priv.get(s, "events") || {})[e.type] && data_priv.get(s, "handle"), f && f.apply(s, t), 
            f = a && s[a], f && f.apply && jQuery.acceptData(s) && (e.result = f.apply(s, t), 
            e.result === !1 && e.preventDefault());
            return e.type = h, !r && !e.isDefaultPrevented() && (!l._default || l._default.apply(c.pop(), t) === !1) && jQuery.acceptData(n) && a && jQuery.isFunction(n[h]) && !jQuery.isWindow(n) && (o = n[a], 
            o && (n[a] = null), jQuery.event.triggered = h, n[h](), jQuery.event.triggered = undefined, 
            o && (n[a] = o)), e.result;
        },
        dispatch:function(e) {
            ...
            while ((i = o[t++]) && !e.isPropagationStopped()) {
                ...
                e.data = s.data, r = ((jQuery.event.special[s.origType] || {}).handle || s.handler).apply(i.elem, u), 
        ...
        handlers:function(e, t) {
            ...
            if (u && a.nodeType && (!e.button || e.type !== "click")) for (;a !== this; a = a.parentNode || this) if (a.disabled !== !0 || e.type !== "click") {
                r = [];
                for (n = 0; n < u; n++) s = t[n], i = s.selector + " ", r[i] === undefined && (r[i] = s.needsContext ? jQuery(i, this).index(a) >= 0 :jQuery.find(i, this, null, [ a ]).length), 
                r[i] && r.push(s);
                r.length && o.push({
                    elem:a,
                    handlers:r
        ...
        mouseHooks:{
            ...
            filter:function(e, t) {
                ...
                !e.which && s !== undefined && (e.which = s & 1 ? 1 :s & 2 ? 3 :s & 4 ? 2 :0), e;
            }
        },
        fix:function(e) {
            ...
            return e.target || (e.target = document), e.target.nodeType === 3 && (e.target = e.target.parentNode), 
        ...
        t && jQuery.extend(this, t), this.timeStamp = e && e.timeStamp || jQuery.now(), 
        ...
        jQuery.event.special[e] = {
            ...
            handle:function(e) {
                ...
                if (!i || i !== r && !jQuery.contains(r, i)) e.type = s.origType, n = s.handler.apply(this, arguments), 
                e.type = t;
                return n;
            }
        };
        ...
        on:function(e, t, n, r, i) {
            ...
            n == null && r == null ? (r = t, n = t = undefined) :r == null && (typeof t == "string" ? (r = n, 
            n = undefined) :(r = n, n = t, t = undefined));
        ...
        off:function(e, t, n) {
            var r, i;
            if (e && e.preventDefault && e.handleObj) return r = e.handleObj, jQuery(e.delegateTarget).off(r.namespace ? r.origType + "." + r.namespace :r.origType, r.selector, r.handler), 
            this;
            if (typeof e == "object") {
    ...
    wrapMap.th = wrapMap.td, jQuery.extend({
        clone:function(e, t, n) {
            ...
            return o = getAll(u, "script"), o.length > 0 && setGlobalEval(o, !a && getAll(e, "script")), 
            u;
        },
        buildFragment:function(e, t, n, r) {
            ...
            for (;h < p; h++) {
                ...
                if (i || i === 0) if (jQuery.type(i) === "object") jQuery.merge(c, i.nodeType ? [ i ] :i); else if (!rhtml.test(i)) c.push(t.createTextNode(i)); else {
                    s = s || l.appendChild(t.createElement("div")), o = (rtagName.exec(i) || [ "", "" ])[1].toLowerCase(), 
                    u = wrapMap[o] || wrapMap._default, s.innerHTML = u[1] + i.replace(rxhtmlTag, "<$1></$2>") + u[2], 
                    f = u[0];
            ...
            while (i = c[h++]) {
                ...
                a = jQuery.contains(i.ownerDocument, i), s = getAll(l.appendChild(i), "script"), 
                a && setGlobalEval(s);
                if (n) {
                    f = 0;
        ...
        empty:function() {
            var e, t = 0;
            for (;(e = this[t]) != null; t++) e.nodeType === 1 && (jQuery.cleanData(getAll(e, !1)), 
            e.textContent = "");
            return this;
        },
        clone:function(e, t) {
        ...
        html:function(e) {
            return access(this, function(e) {
                ...
                if (typeof e == "string" && !rnoInnerhtml.test(e) && !wrapMap[(rtagName.exec(e) || [ "", "" ])[1].toLowerCase()]) {
                    ...
                    try {
                        for (;n < r; n++) t = this[n] || {}, t.nodeType === 1 && (jQuery.cleanData(getAll(t, !1)), 
                        t.innerHTML = e);
                        t = 0;
                    } catch (i) {}
                }
        ...
        domManip:function(e, t) {
            ...
            if (f) {
                n = jQuery.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 
                n.childNodes.length === 1 && (n = r);
                if (r) {
                    i = jQuery.map(getAll(n, "script"), disableScript), s = i.length;
                    for (;a < f; a++) o = n, a !== c && (o = jQuery.clone(o, !0, !0), s && jQuery.merge(i, getAll(o, "script"))), 
                    t.call(this[a], o, a);
                    if (s) {
    ...
    (function() {
        ...
        support.clearCloneStyle = i.style.backgroundClip === "content-box", r.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", 
        r.appendChild(i), window.getComputedStyle && jQuery.extend(support, {
            ...
            reliableMarginRight:function() {
                ...
                t.style.marginRight = t.style.width = "0", i.style.width = "1px", n.appendChild(r), 
                e = !parseFloat(window.getComputedStyle(t, null).marginRight), n.removeChild(r), 
                e;
            }
        });
    ...
    jQuery.extend({
        ...
        style:function(e, t, n, r) {
            ...
            s = typeof n, s === "string" && (i = rrelNum.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(jQuery.css(e, t)), 
            s = "number");
        ...
        css:function(e, t, n, r) {
            ...
            o = jQuery.cssHooks[t] || jQuery.cssHooks[u], o && "get" in o && (i = o.get(e, !0, n)), 
            i === undefined && (i = curCSS(e, t, r)), i === "normal" && t in cssNormalTransform && (i = cssNormalTransform[t]), 
        ...
        init:function(e, t, n, r, i, s) {
            ...
            this.end = r, this.unit = s || (jQuery.cssNumber[n] ? "" :"px");
        },
        cur:function() {
    ...
    jQuery.Animation = jQuery.extend(Animation, {
        ...
        stop:function(e, t, n) {
            ...
            return typeof e != "string" && (n = t, t = e, e = undefined), t && e !== !1 && this.queue(e || "fx", []), 
            this.each(function() {
                ...
                for (i = s.length; i--; ) s[i].elem === this && (e == null || s[i].queue === e) && (s[i].anim.stop(n), 
                t = !1, s.splice(i, 1));
        ...
        finish:function(e) {
            return e !== !1 && (e = e || "fx"), this.each(function() {
                ...
                for (t = s.length; t--; ) s[t].elem === this && s[t].queue === e && (s[t].anim.stop(!0), 
                s.splice(t, 1));
        ...
        e.type = "checkbox", support.checkOn = e.value !== "", support.optSelected = n.selected, 
        t.disabled = !0, support.optDisabled = !n.disabled, e = document.createElement("input"), 
        e.value = "t", e.type = "radio", support.radioValue = e.value === "t";
    }();
    ...
    jQuery.fn.extend({
        ...
        attr:function(e, t, n) {
            ...
            if (n === undefined) return r && "get" in r && (i = r.get(e, t)) !== null ? i :(i = jQuery.find.attr(e, t), 
            i == null ? undefined :i);
            if (n !== null) return r && "set" in r && (i = r.set(e, n, t)) !== undefined ? i :(e.setAttribute(t, n + ""), 
            n);
            jQuery.removeAttr(e, t);
        },
        removeAttr:function(e, t) {
            var n, r, i = 0, s = t && t.match(rnotwhite);
            if (s && e.nodeType === 1) while (n = s[i++]) r = jQuery.propFix[n] || n, jQuery.expr.match.bool.test(n) && (e[r] = !1), 
            e.removeAttribute(n);
        },
        attrHooks:{
            type:{
        ...
        attrHandle[t] = function(e, t, r) {
            var i, s;
            return r || (s = attrHandle[t], attrHandle[t] = i, i = n(e, t, r) != null ? t.toLowerCase() :null, 
            attrHandle[t] = s), i;
        };
    });
    ...
    jQuery.fn.extend({
        ...
        prop:function(e, t, n) {
            ...
            return s = o !== 1 || !jQuery.isXMLDoc(e), s && (t = jQuery.propFix[t] || t, i = jQuery.propHooks[t]), 
    ...
    ajaxLocParts = rurl.exec(ajaxLocation.toLowerCase()) || [], jQuery.extend({
        ...
        ajax:function(e, t) {
            function S(e, t, s, u) {
                var f, m, g, b, E, S = t;
                if (y === 2) return;
                y = 2, o && clearTimeout(o), n = undefined, i = u || "", w.readyState = e > 0 ? 4 :0, 
                f = e >= 200 && e < 300 || e === 304, s && (b = ajaxHandleResponses(l, w, s)), b = ajaxConvert(l, b, w, f);
                if (f) l.ifModified && (E = w.getResponseHeader("Last-Modified"), E && (jQuery.lastModified[r] = E), 
                E = w.getResponseHeader("etag"), E && (jQuery.etag[r] = E)), e === 204 || l.type === "HEAD" ? S = "nocontent" :e === 304 ? S = "notmodified" :(S = b.state, 
                m = b.data, g = b.error, f = !g); else {
                    g = S;
                    if (e || !S) S = "error", e < 0 && (e = 0);
                }
                w.status = e, w.statusText = (t || S) + "", f ? p.resolveWith(c, [ m, S, w ]) :p.rejectWith(c, [ w, S, g ]), 
                w.statusCode(v), v = undefined, a && h.trigger(f ? "ajaxSuccess" :"ajaxError", [ w, l, f ? m :g ]), 
                d.fireWith(c, [ w, S ]), a && (h.trigger("ajaxComplete", [ w, l ]), --jQuery.active || jQuery.event.trigger("ajaxStop"));
            }
            ...
            l.type = t.method || t.type || l.method || l.type, l.dataTypes = jQuery.trim(l.dataType || "*").toLowerCase().match(rnotwhite) || [ "" ], 
            ...
            if (y === 2) return w;
            a = l.global, a && jQuery.active++ === 0 && jQuery.event.trigger("ajaxStart"), l.type = l.type.toUpperCase(), 
            l.hasContent = !rnoContent.test(l.type), r = l.url, l.hasContent || (l.data && (r = l.url += (rquery.test(r) ? "&" :"?") + l.data, 
            delete l.data), l.cache === !1 && (l.url = rts.test(r) ? r.replace(rts, "$1_=" + nonce++) :r + (rquery.test(r) ? "&" :"?") + "_=" + nonce++)), 
            l.ifModified && (jQuery.lastModified[r] && w.setRequestHeader("If-Modified-Since", jQuery.lastModified[r]), 
            jQuery.etag[r] && w.setRequestHeader("If-None-Match", jQuery.etag[r])), (l.data && l.hasContent && l.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", l.contentType), 
        ...
        wrapAll:function(e) {
            ...
            }) :(this[0] && (t = jQuery(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), 
            t.map(function() {
                var e = this;
    ...
    jQuery.ajaxSetup({
        ...
        e.converters["script json"] = function() {
            ...
            window[r] = i, e[r] && (e.jsonpCallback = t.jsonpCallback, oldCallbacks.push(r)), 
            s && jQuery.isFunction(i) && i(s[0]), s = i = undefined;
        }), "script";
    }), jQuery.parseHTML = function(e, t, n) {
        if (!e || typeof e != "string") return null;
        typeof t == "boolean" && (n = t, t = !1), t = t || document;
        var r = rsingleTag.exec(e), i = !n && [];
        return r ? [ t.createElement(r[1]) ] :(r = jQuery.buildFragment([ e ], t, i), i && i.length && jQuery(i).remove(), 
    ...
    jQuery.fn.load = function(e, t, n) {
        ...
        return u >= 0 && (r = jQuery.trim(e.slice(u)), e = e.slice(0, u)), jQuery.isFunction(t) ? (n = t, 
        t = undefined) :t && typeof t == "object" && (i = "POST"), o.length > 0 && jQuery.ajax({
            url:e,
            type:i,
            dataType:"html",
            data:t
    ...
    jQuery.offset = {
        setOffset:function(e, t, n) {
            ...
            l === "static" && (e.style.position = "relative"), u = c.offset(), s = jQuery.css(e, "top"), 
            a = jQuery.css(e, "left"), f = (l === "absolute" || l === "fixed") && (s + a).indexOf("auto") > -1, 
            f ? (r = c.position(), o = r.top, i = r.left) :(o = parseFloat(s) || 0, i = parseFloat(a) || 0), 
            jQuery.isFunction(t) && (t = t.call(e, n, u)), t.top != null && (h.top = t.top - u.top + o), 
        ...
        offset:function(e) {
            ...
            if (!s) return;
            return t = s.documentElement, jQuery.contains(t, r) ? (typeof r.getBoundingClientRect !== strundefined && (i = r.getBoundingClientRect()), 
            n = getWindow(s), {
        ...
        position:function() {
            ...
            t = this.offset(), jQuery.nodeName(e[0], "html") || (r = e.offset()), r.top += jQuery.css(e[0], "borderTopWidth", !0), 
    ...
    return jQuery.noConflict = function(e) {
        return window.$ === jQuery && (window.$ = _$), e && window.jQuery === jQuery && (window.jQuery = _jQuery), 
        jQuery;
    ...
    var n, r = {
        ...
        var t = e(".book"), r = e(this).data("theme");
        n.theme !== 0 && t.removeClass("color-theme-" + n.theme), n.theme = r, n.theme !== 0 && t.addClass("color-theme-" + n.theme), 
        n.save();
    }, f = function() {
        var t = e(".book");
        e(".font-settings .font-family-list li").removeClass("active"), e(".font-settings .font-family-list li:nth-child(" + (n.family + 1) + ")").addClass("active"), 
        t[0].className = t[0].className.replace(/\bfont-\S+/g, ""), t.addClass("font-size-" + n.size), 
        t.addClass("font-family-" + n.family), n.theme !== 0 && (t[0].className = t[0].className.replace(/\bcolor-theme-\S+/g, ""), 
        t.addClass("color-theme-" + n.theme));
    }, l = function(l) {
        var c, h, p, d;
        d = e(".book"), c = e(".book-header .toggle-font-settings"), p = e("#font-settings-wrapper .dropdown-menu"), 
        h = e(".book-body"), n = t.get("fontState", {
            size:l.size || 2,
            family:i[l.family || "sans"],
            theme:r[l.theme || "white"]
        }), n.save = function() {
            t.set("fontState", n), f();
        }, f(), e(document).on("click", "#enlarge-font-size", s), e(document).on("click", "#reduce-font-size", o), 
    ...
    function w(e, t, n, r, i, s) {
        ...
        for (o = 0; o < a[e].length; ++o) {
            ...
            if (c == "keypress" && !n.metaKey && !n.ctrlKey || y(t, u.modifiers)) {
                var h = !r && u.combo == i, p = r && u.seq == r && u.level == s;
    ...
    function O(e, t, n) {
        return n || (n = A()[e] ? "keydown" :"keypress"), n == "keypress" && t.length && (n = "keydown"), 
        n;
    }
    function M(e, t, n, r) {
        function i(t) {
        ...
        for (var o = 0; o < t.length; ++o) {
            var u = o + 1 === t.length, a = u ? s :i(r || D(t[o + 1]).action);
            P(t[o], a, r, e, o);
        }
    }
    function _(e) {
    ...
    function D(e, t) {
        var n, r, i, u = [];
        n = _(e);
        for (i = 0; i < n.length; ++i) r = n[i], o[r] && (r = o[r]), t && t != "keypress" && s[r] && (r = s[r], 
        u.push("shift")), k(r) && u.push(r);
        return t = O(r, u, t), {
            key:r,
            modifiers:u,
            action:t
    ...
    function N(e) {
        ...
        while (n < r) i = e.charCodeAt(n++), i >= 55296 && i <= 56319 && n < r ? (s = e.charCodeAt(n++), 
    ...
    function C(e) {
        return x(e, function(e) {
            var t = "";
            return e > 65535 && (e -= 65536, t += w(e >>> 10 & 1023 | 55296), e = 56320 | e & 1023), 
            t += w(e), t;
        }).join("");
    }
    function k(e) {
    ...
    function O(e) {
        ...
        for (m = d > 0 ? d + 1 :0; m < n; ) {
            for (g = i, y = 1, w = o; ;w += o) {
                m >= n && S("invalid-input"), E = k(e.charCodeAt(m++)), (E >= o || E > b((s - i) / y)) && S("overflow"), 
                i += E * y, x = w <= l ? u :w >= l + a ? a :w - l;
                if (E < x) break;
                N = o - x, y > b(s / N) && S("overflow"), y *= N;
            }
            r = t.length + 1, l = A(i - g, r, g == 0), b(i / r) > s - f && S("overflow"), f += b(i / r), 
            i %= r, t.splice(i++, 0, f);
        }
        return C(t);
    }
    ...
    var t = typeof exports == "object" && exports, n = typeof module == "object" && module && module.exports == t && module, r = typeof global == "object" && global;
    ...
    if (typeof define == "function" && typeof define.amd == "object" && define.amd) define("URIjs/punycode", [], function() {
        return i;
    }); else if (t && !t.nodeType) if (n) n.exports = i; else for (E in i) i.hasOwnProperty(E) && (t[E] = i[E]); else e.punycode = i;
}(this), function(e, t) {
    "use strict";
    ...
    function n(e) {
        ...
        r = n.length, n[r - 1].indexOf(".") !== -1 && (i = 7);
        var s;
        ...
        var f = -1, l = 0, c = 0, h = -1, p = !1;
        for (u = 0; u < i; u++) p ? n[u] === "0" ? c += 1 :(p = !1, c > l && (f = h, l = c)) :n[u] === "0" && (p = !0, 
        h = u, c = 1);
    ...
    function s(e, t) {
        ...
        this.href(e), t !== undefined ? this.absoluteTo(t) :this) :new s(e, t);
    }
    function a(e) {
    ...
    function c(e, t) {
        var n = {}, r, i;
        if (l(t)) for (r = 0, i = t.length; r < i; r++) n[t[r]] = !0; else n[t] = !0;
        for (r = 0, i = e.length; r < i; r++) n[e[r]] !== undefined && (e.splice(r, 1), 
        i--, r--);
        return e;
    }
    function h(e, t) {
        ...
        var i = f(t);
        for (n = 0, r = e.length; n < r; n++) if (i === "RegExp") {
    ...
    var i = r && r.URI;
    s.version = "1.13.1";
    var o = s.prototype, u = Object.prototype.hasOwnProperty;
    s._parts = function() {
        return {
            protocol:null,
            username:null,
    ...
    s.encodeReserved = y("reserved", "encode"), s.parse = function(e, t) {
        var n;
        return t || (t = {}), n = e.indexOf("#"), n > -1 && (t.fragment = e.substring(n + 1) || null, 
        e = e.substring(0, n)), n = e.indexOf("?"), n > -1 && (t.query = e.substring(n + 1) || null, 
        e = e.substring(0, n)), e.substring(0, 2) === "//" ? (t.protocol = null, e = e.substring(2), 
        e = s.parseAuthority(e, t)) :(n = e.indexOf(":"), n > -1 && (t.protocol = e.substring(0, n) || null, 
        ...
        e = s.parseAuthority(e, t)) :(e = e.substring(n + 1), t.urn = !0))), t.path = e, 
        t;
    }, s.parseHost = function(e, t) {
        var n = e.indexOf("/"), r, i;
        return n === -1 && (n = e.length), e.charAt(0) === "[" ? (r = e.indexOf("]"), t.hostname = e.substring(1, r) || null, 
        t.port = e.substring(r + 2, n) || null, t.port === "/" && (t.port = null)) :e.indexOf(":") !== e.lastIndexOf(":") ? (t.hostname = e.substring(0, n) || null, 
        t.port = null) :(i = e.substring(0, n).split(":"), t.hostname = i[0] || null, t.port = i[1] || null), 
        t.hostname && e.substring(n).charAt(0) !== "/" && (n++, e = "/" + e), e.substring(n) || "/";
        ...
        return r > -1 && (n === -1 || r < n) ? (i = e.substring(0, r).split(":"), t.username = i[0] ? s.decode(i[0]) :null, 
        ...
        for (var f = 0; f < i; f++) o = r[f].split("="), u = s.decodeQuery(o.shift(), t), 
        a = o.length ? s.decodeQuery(o.join("="), t) :null, n[u] ? (typeof n[u] == "string" && (n[u] = [ n[u] ]), 
        n[u].push(a)) :n[u] = a;
        return n;
    }, s.build = function(e) {
        var t = "";
        return e.protocol && (t += e.protocol + ":"), !e.urn && (t || e.hostname) && (t += "//"), 
        t += s.buildAuthority(e) || "", typeof e.path == "string" && (e.path.charAt(0) !== "/" && typeof e.hostname == "string" && (t += "/"), 
        t += e.path), typeof e.query == "string" && e.query && (t += "?" + e.query), typeof e.fragment == "string" && e.fragment && (t += "#" + e.fragment), 
        t;
        ...
        var r = "", i, o, a, f;
        for (o in e) if (u.call(e, o) && o) if (l(e[o])) {
            i = {};
            for (a = 0, f = e[o].length; a < f; a++) e[o][a] !== undefined && i[e[o][a] + ""] === undefined && (r += "&" + s.buildQueryParameter(o, e[o][a], n), 
            t !== !0 && (i[e[o][a] + ""] = !0));
        ...
        if (typeof t == "object") for (var r in t) u.call(t, r) && s.addQuery(e, r, t[r]); else {
        ...
        var r, i, o;
        if (l(t)) for (r = 0, i = t.length; r < i; r++) e[t[r]] = undefined; else if (typeof t == "object") for (o in t) u.call(t, o) && s.removeQuery(e, o, t[o]); else {
        ...
        n || (n = {});
        var r = n.start || s.findUri.start, i = n.end || s.findUri.end, o = n.trim || s.findUri.trim, u = /[a-z0-9-]=["']?$/i;
        r.lastIndex = 0;
        for (;;) {
            var a = r.exec(e);
            if (!a) break;
            ...
            var c = f + e.slice(f).search(i), h = e.slice(f, c).replace(o, "");
        ...
        if (e === !0) this._deferred_build = !0; else if (e === undefined || this._deferred_build) this._string = s.build(this._parts), 
        ...
        return function(t, n) {
            return t === undefined ? this._parts[e] || "" :(this._parts[e] = t || null, this.build(!n), 
            this);
        };
    };
    ...
    m = {
        ...
        return function(n, r) {
            return n === undefined ? this._parts[e] || "" :(n !== null && (n += "", n.charAt(0) === t && (n = n.substring(1))), 
    ...
    o.pathname = function(e, t) {
        ...
        var r = e instanceof s, i = typeof e == "object" && (e.hostname || e.path || e.pathname);
        if (e.nodeName) {
            var o = s.getDomAttribute(e);
            e = e[o] || "", i = !1;
        }
        !r && i && e.pathname !== undefined && (e = e.toString());
        if (typeof e == "string") this._parts = s.parse(e, this._parts); else {
        ...
        var t = !1, r = !1, i = !1, o = !1, u = !1, a = !1, f = !1, l = !this._parts.urn;
        this._parts.hostname && (l = !1, r = s.ip4_expression.test(this._parts.hostname), 
        i = s.ip6_expression.test(this._parts.hostname), t = r || i, o = !t, u = o && n && n.has(this._parts.hostname), 
        a = o && s.idn_expression.test(this._parts.hostname), f = o && s.punycode_expression.test(this._parts.hostname));
    ...
    var b = o.protocol, w = o.port, E = o.hostname;
    o.protocol = function(e, t) {
        ...
        var r = this._parts.hostname.length - this.domain().length, i = this._parts.hostname.substring(0, r), o = new RegExp("^" + a(i));
        return e && e.charAt(e.length - 1) !== "." && (e += "."), e && s.ensureValidHostname(e), 
        this._parts.hostname = this._parts.hostname.replace(o, e), this.build(!t), this;
        ...
        if (!this._parts.hostname || this.is("IP")) this._parts.hostname = e; else {
        ...
        var i = this._parts.path.length - this.filename().length, o = this._parts.path.substring(0, i), u = new RegExp("^" + a(o));
        return this.is("relative") || (e || (e = "/"), e.charAt(0) !== "/" && (e = "/" + e)), 
        e && e.charAt(e.length - 1) !== "/" && (e += "/"), e = s.recodePath(e), this._parts.path = this._parts.path.replace(u, e), 
        this.build(!t), this;
        ...
        return e = s.recodePath(e), this._parts.path = this._parts.path.replace(o, e), i ? this.normalizePath(t) :this.build(!t), 
        this;
        ...
        if (e === undefined || e === !0) {
            ...
            return r === -1 ? "" :(i = n.substring(r + 1), o = /^[a-z0-9%]+$/i.test(i) ? i :"", 
        ...
        var r = this._parts.urn ? ":" :"/", i = this.path(), s = i.substring(0, 1) === "/", o = i.split(r);
        ...
        if (t === undefined) {
            ...
            if (!l(r)) r = r !== undefined ? s.decode(r) :undefined; else for (i = 0, o = r.length; i < o; i++) r[i] = s.decode(r[i]);
            return r;
        }
        if (!l(t)) t = typeof t == "string" ? s.encode(t) :t; else for (i = 0, o = t.length; i < o; i++) t[i] = s.decode(t[i]);
    ...
    return o.query = function(e, t) {
        ...
        if (typeof e == "function") {
            var n = s.parseQuery(this._parts.query, this._parts.escapeQuerySpace), r = e.call(this, n);
        ...
        this.build(!t), this) :S.call(this, e, t);
    }, o.setQuery = function(e, t, n) {
        var r = s.parseQuery(this._parts.query, this._parts.escapeQuerySpace);
        if (typeof e == "object") for (var i in e) u.call(e, i) && (r[i] = e[i]); else {
        ...
        typeof e != "string" && (n = t), this.build(!n), this;
    }, o.addQuery = function(e, t, n) {
        var r = s.parseQuery(this._parts.query, this._parts.escapeQuerySpace);
        return s.addQuery(r, e, t === undefined ? null :t), this._parts.query = s.buildQuery(r, this._parts.duplicateQueryParameters, this._parts.escapeQuerySpace), 
        typeof e != "string" && (n = t), this.build(!n), this;
    }, o.removeQuery = function(e, t, n) {
        var r = s.parseQuery(this._parts.query, this._parts.escapeQuerySpace);
        return s.removeQuery(r, e, t), this._parts.query = s.buildQuery(r, this._parts.duplicateQueryParameters, this._parts.escapeQuerySpace), 
        typeof e != "string" && (n = t), this.build(!n), this;
    ...
    o.hasSearch = o.hasQuery, o.normalize = function() {
        ...
        n.charAt(0) !== "/" && (t = !0, n = "/" + n), n = n.replace(/(\/(\.\/)+)|(\/\.$)/g, "/").replace(/\/{2,}/g, "/"), 
        t && (r = n.substring(1).match(/^(\.\.\/)+/) || "", r && (r = r[0]));
        for (;;) {
            i = n.indexOf("/..");
            if (i === -1) break;
            if (i === 0) {
        ...
        return t && this.is("relative") && (n = r + n.substring(1)), n = s.recodePath(n), 
        this._parts.path = n, this.build(!e), this;
    ...
    o.iso8859 = function() {
        ...
        var e = s.encode, t = s.decode;
        return s.encode = v, s.decode = unescape, this.normalize(), s.encode = e, s.decode = t, 
        this;
    }, o.readable = function() {
        var t = this.clone();
        t.username("").password("").normalize();
        var n = "";
        t._parts.protocol && (n += t._parts.protocol + "://"), t._parts.hostname && (t.is("punycode") && e ? (n += e.toUnicode(t._parts.hostname), 
        ...
        t._parts.query || (t._parts.query = e._parts.query)), t.path().charAt(0) !== "/" && (r = e.directory(), 
        t._parts.path = (r ? r + "/" :"") + t._parts.path, t.normalizePath()), t.build(), 
        t;
    ...
    function U(e) {
        ...
        if (n == "boolean" || e == null) t[e] = !0; else {
            n != "number" && n != "string" && (n = "object");
            var r = n == "number" ? e :i + e, s = t[n] || (t[n] = {});
    ...
    function W(e, t) {
        var n = e.criteria, r = t.criteria, i = -1, s = n.length;
        while (++i < s) {
            var o = n[i], u = r[i];
            if (o !== u) {
    ...
    function X(e) {
        var t = -1, n = e.length, r = e[0], i = e[n / 2 | 0], s = e[n - 1];
    ...
    function Q(e) {
        var t = e.cache;
        t && Q(t), e.array = e.cache = e.criteria = e.object = e.number = e.string = e.value = null, 
        n.length < o && n.push(e);
    }
    function G(e, t, n) {
    ...
    function Y(t) {
        ...
        function Mt(e) {
            function i() {
                ...
                if (this instanceof i) {
                    var s = Dt(t.prototype), o = t.apply(s, e || arguments);
                    return Cn(o) ? o :s;
                }
                return t.apply(r, e || arguments);
            }
            var t = e[0], n = e[2], r = e[4];
            return $t(i, e), i;
        }
        function _t(e, t, n, r, i) {
            ...
            return f && (ht.call(e, "index") && (s.index = e.index), ht.call(e, "input") && (s.input = e.input)), 
            t ? (r.push(e), i.push(s), (f ? Jn :dn)(e, function(e, o) {
                s[o] = _t(e, t, n, r, i);
            }), l && (K(r), K(i)), s) :s;
        }
        function Dt(e, t) {
        ...
        function Ht(e) {
            ...
            var t = e[0], n = e[1], r = e[2], i = e[3], s = e[4], o = e[5], u = n & 1, a = n & 2, f = n & 4, l = n & 8, c = t;
            return $t(h, e), h;
        }
        function Bt(e, t) {
            var n = -1, r = Xt(), i = e ? e.length :0, o = i >= s && r === q, u = [];
            if (o) {
                var a = X(t);
                a ? (r = R, t = a) :o = !1;
            }
        ...
        function jt(e, t, n, r) {
            var i = (r || 0) - 1, s = e ? e.length :0, o = [];
            while (++i < s) {
                var u = e[i];
                if (u && typeof u == "object" && typeof u.length == "number" && (Gt(u) || Qt(u))) {
                    t || (u = jt(u, t, n));
                    var a = -1, f = u.length, l = o.length;
                    o.length += f;
                    while (++a < f) o[l++] = u[a];
                } else n || o.push(u);
            }
        ...
        function Ft(e, t, n, r, i, s) {
            ...
            var u = typeof e, a = typeof t;
            if (e === e && (!e || !D[u]) && (!t || !D[a])) return !1;
            if (e == null || t == null) return e === t;
            var f = st.call(e), l = st.call(t);
            f == E && (f = k), l == E && (l = k);
            if (f != l) return !1;
            switch (f) {
              case x:
            ...
            var c = f == S;
            if (!c) {
                var h = ht.call(e, "__wrapped__"), p = ht.call(t, "__wrapped__");
        ...
        function Rt(e, t, n) {
            var r = -1, i = Xt(), o = e ? e.length :0, u = [], a = !t && o >= s && i === q, f = n || a ? $() :u;
            if (a) {
                var l = X(f);
                i = R, f = l;
            }
            while (++r < o) {
                var c = e[r], h = n ? n(c, r, e) :c;
        ...
        function Ut(e) {
            return function(t, n, r) {
                ...
                var s = -1, o = t ? t.length :0;
                if (typeof o == "number") while (++s < o) {
                    var u = t[s];
                    e(i, u, n(u, s, t), t);
        ...
        function zt(e, t, n, r, i, s) {
            var o = t & 1, u = t & 2, a = t & 4, f = t & 8, l = t & 16, c = t & 32;
            if (!u && !Nn(e)) throw new tt();
            l && !n.length && (t &= -17, l = n = !1), c && !r.length && (t &= -33, c = r = !1);
            var h = e && e.__bindData__;
            if (h && h !== !0) return h = G(h), h[2] && (h[2] = G(h[2])), h[3] && (h[3] = G(h[3])), 
            o && !(h[1] & 1) && (h[4] = i), !o && h[1] & 1 && (t |= 8), a && !(h[1] & 4) && (h[5] = s), 
            l && pt.apply(h[2] || (h[2] = []), n), c && mt.apply(h[3] || (h[3] = []), r), h[1] |= t, 
            zt.apply(null, h);
        ...
        function Hn(e) {
            ...
            if (n > 3 && typeof t[n - 2] == "function") var r = Pt(t[--n - 1], t[n--], 2); else n > 2 && typeof t[n - 1] == "function" && (r = t[--n]);
            var i = G(arguments, 1, n), s = -1, o = $(), u = $();
        ...
        function jn(e) {
            var t = -1, r = Zt(e), i = r.length, s = n(i);
            while (++t < i) {
                var o = r[t];
                s[t] = [ o, e[o] ];
            }
        ...
        function Fn(e, t, n) {
            var r = {};
            if (typeof t != "function") {
                var i = -1, s = jt(arguments, !0, !1, 1), o = Cn(e) ? s.length :0;
                while (++i < o) {
                    var u = s[i];
                    u in e && (r[u] = e[u]);
                }
        ...
        function In(e, t, n, r) {
            var i = Gt(e);
            if (n == null) if (i) n = []; else {
                var s = e && e.constructor, o = s && s.prototype;
                n = Dt(o);
            }
        ...
        function Rn(e) {
            var t = arguments, r = -1, i = jt(t, !0, !1, 1), s = t[2] && t[2][t[1]] === e ? 1 :i.length, o = n(s);
            while (++r < s) o[r] = e[i[r]];
            return o;
        }
        function Un(e, t, n) {
            var r = -1, i = Xt(), s = e ? e.length :0, o = !1;
        ...
        function Yn(e, t) {
            var r = G(arguments, 2), i = -1, s = typeof t == "function", o = e ? e.length :0, u = n(typeof o == "number" ? o :0);
        ...
        function ur(e) {
            var t = -1, r = e ? e.length :0, i = n(typeof r == "number" ? r :0);
            return Jn(e, function(e) {
                var n = qt(0, ++t);
                i[t] = i[n], i[n] = e;
            }), i;
        ...
        function lr(e, t, r) {
            var i = -1, s = Gt(t), o = e ? e.length :0, u = n(typeof o == "number" ? o :0);
        ...
        function yr(e, t, n, r) {
            return typeof t != "boolean" && t != null && (r = n, n = typeof t != "function" && r && r[t] === e ? null :t, 
            t = !1), n != null && (e = Zn(e, n, r)), jt(e, t);
        }
        function br(e, t, n) {
            if (typeof n == "number") {
                var r = e ? e.length :0;
        ...
        function Er() {
            var e = [], t = -1, n = arguments.length, r = $(), i = Xt(), o = i === q, u = $();
            while (++t < n) {
                var a = arguments[t];
                if (Gt(a) || Qt(a)) e.push(a), r.push(o && a.length >= s && X(t ? e[t] :u));
            }
            var f = e[0], l = -1, c = f ? f.length :0, h = [];
            e:while (++l < c) {
                var p = r[0];
                a = f[l];
                if ((p ? R(p, a) :i(u, a)) < 0) {
        ...
        function Tr(e) {
            var t = arguments, n = 0, r = t.length, i = e ? e.length :0;
            while (++n < r) {
                var s = -1, o = t[n];
        ...
        function Nr(e, t, r) {
            ...
            var i = -1, s = xt(0, ut((t - e) / (r || 1))), o = n(s);
            while (++i < s) o[i] = e, e += r;
            return o;
        }
        function Cr(e, t, n) {
        ...
        function Or(e, t, n, r) {
            return typeof t != "boolean" && t != null && (r = n, n = typeof t != "function" && r && r[t] === e ? null :t, 
            t = !1), n != null && (n = Lt.createCallback(n, r, 3)), Rt(e, t, n);
        }
        function Mr(e) {
        ...
        function Dr() {
            var e = arguments.length > 1 ? arguments :arguments[0], t = -1, r = e ? er(nr(e, "length")) :0, i = n(r < 0 ? 0 :r);
        ...
        function jr(e) {
            var t = arguments.length > 1 ? jt(arguments, !0, !1, 1) :mn(e), n = -1, r = t.length;
            while (++n < r) {
                var i = t[n];
        ...
        function Rr(t, n, r) {
            ...
            return function() {
                ...
                if (h === !1) var e = d && !f; else {
                    !s && !d && (c = u);
                    var r = h - (u - c), g = r <= 0;
                    g ? (s && (s = at(s)), c = u, o = t.apply(a, i)) :s || (s = dt(m, r));
                }
                return g && f ? f = at(f) :!f && n !== h && (f = dt(v, n)), e && (g = !0, o = t.apply(a, i)), 
                g && !f && !s && (i = a = null), o;
            };
        }
        function Ur(t) {
        ...
        function Wr(e, t) {
            ...
            var n = function() {
                var r = n.cache, s = t ? t.apply(this, arguments) :i + arguments[0];
        ...
        function Jr(e, t, n) {
            var r = !0, i = !0;
            if (!Nn(e)) throw new tt();
            return n === !1 ? r = !1 :Cn(n) && (r = "leading" in n ? n.leading :r, i = "trailing" in n ? n.trailing :i), 
            M.leading = r, M.maxWait = t, M.trailing = i, Rr(e, t, M);
        }
        function Kr(e, t) {
            return zt(t, 16, [ e ]);
        }
        ...
        function oi(e, t, n) {
            ...
            n == null && (typeof e == "boolean" && i ? (n = e, e = 1) :!i && typeof t == "boolean" && (n = t, 
            i = !0)), r && i && (t = 1), e = +e || 0, i ? (t = e, e = 0) :t = +t || 0;
            if (n || e % 1 || t % 1) {
                var s = Ct();
        ...
        var $t = gt ? function(e, t) {
            ...
            '"':"&quot;",
            "'":"&#39;"
        }, tn = yn(en), nn = U("(" + Zt(tn).join("|") + ")", "g"), rn = U("[" + Zt(en).join("") + "]", "g"), sn = function(e, t, n) {
            var r, i = e, s = i;
            if (!i) return s;
            var o = arguments, u = 0, a = typeof n == "number" ? 2 :o.length;
            if (a > 3 && typeof o[a - 2] == "function") var f = Pt(o[--a - 1], o[a--], 2); else a > 2 && typeof o[a - 1] == "function" && (f = o[--a]);
            while (++u < a) {
                i = o[u];
                if (i && D[typeof i]) {
                    var l = -1, c = D[typeof i] && Zt(i), h = c ? c.length :0;
            ...
            while (++u < a) {
                i = o[u];
                if (i && D[typeof i]) {
                    var f = -1, l = D[typeof i] && Zt(i), c = l ? l.length :0;
            ...
            if (!D[typeof i]) return s;
            t = t && typeof n == "undefined" ? t :Pt(t, n, 3);
            var o = -1, u = D[typeof i] && Zt(i), a = u ? u.length :0;
            while (++o < a) {
                r = u[o];
            ...
            var t = e.valueOf, n = Vt(t) && (n = ct(t)) && ct(n);
            return n ? e == n || ct(e) == n :Jt(e);
        } :Jt, zn = Ut(function(e, t, n) {
            ht.call(e, n) ? e[n]++ :e[n] = 1;
        }), Qn = Ut(function(e, t, n) {
            (ht.call(e, n) ? e[n] :e[n] = []).push(t);
        }), Gn = Ut(function(e, t, n) {
            e[n] = t;
        }), nr = Zn, hr = Xn, ri = Vt(ri = P.now) && ri || function() {
            return new P().getTime();
        }, ii = Nt(u + "08") == 8 ? Nt :function(e, t) {
            return Nt(_n(e) ? e.replace(v, "") :e, t || 0);
        };
        return Lt.after = Hr, Lt.assign = sn, Lt.at = Rn, Lt.bind = Br, Lt.bindAll = jr, 
        Lt.bindKey = Fr, Lt.chain = hi, Lt.compact = pr, Lt.compose = Ir, Lt.constant = Qr, 
        Lt.countBy = zn, Lt.create = an, Lt.createCallback = Gr, Lt.curry = qr, Lt.debounce = Rr, 
        Lt.defaults = fn, Lt.defer = Ur, Lt.delay = zr, Lt.difference = dr, Lt.filter = Xn, 
        Lt.flatten = yr, Lt.forEach = Jn, Lt.forEachRight = Kn, Lt.forIn = hn, Lt.forInRight = pn, 
        Lt.forOwn = dn, Lt.forOwnRight = vn, Lt.functions = mn, Lt.groupBy = Qn, Lt.indexBy = Gn, 
        Lt.initial = wr, Lt.intersection = Er, Lt.invert = yn, Lt.invoke = Yn, Lt.keys = Zt, 
        Lt.map = Zn, Lt.mapValues = Pn, Lt.max = er, Lt.memoize = Wr, Lt.merge = Hn, Lt.min = tr, 
        Lt.omit = Bn, Lt.once = Xr, Lt.pairs = jn, Lt.partial = Vr, Lt.partialRight = $r, 
        Lt.pick = Fn, Lt.pluck = nr, Lt.property = si, Lt.pull = Tr, Lt.range = Nr, Lt.reject = sr, 
        Lt.remove = Cr, Lt.rest = kr, Lt.shuffle = ur, Lt.sortBy = lr, Lt.tap = pi, Lt.throttle = Jr, 
        Lt.times = fi, Lt.toArray = cr, Lt.transform = In, Lt.union = Ar, Lt.uniq = Or, 
        Lt.values = qn, Lt.where = hr, Lt.without = Mr, Lt.wrap = Kr, Lt.xor = _r, Lt.zip = Dr, 
        Lt.zipObject = Pr, Lt.collect = Zn, Lt.drop = kr, Lt.each = Jn, Lt.eachRight = Kn, 
        Lt.extend = sn, Lt.methods = mn, Lt.object = Pr, Lt.select = Xn, Lt.tail = kr, Lt.unique = Or, 
        Lt.unzip = Dr, ei(Lt), Lt.clone = on, Lt.cloneDeep = un, Lt.contains = Un, Lt.escape = Yr, 
        Lt.every = Wn, Lt.find = Vn, Lt.findIndex = vr, Lt.findKey = ln, Lt.findLast = $n, 
        Lt.findLastIndex = mr, Lt.findLastKey = cn, Lt.has = gn, Lt.identity = Zr, Lt.indexOf = br, 
        Lt.isArguments = Qt, Lt.isArray = Gt, Lt.isBoolean = bn, Lt.isDate = wn, Lt.isElement = En, 
        Lt.isEmpty = Sn, Lt.isEqual = xn, Lt.isFinite = Tn, Lt.isFunction = Nn, Lt.isNaN = kn, 
        Lt.isNull = Ln, Lt.isNumber = An, Lt.isObject = Cn, Lt.isPlainObject = On, Lt.isRegExp = Mn, 
        Lt.isString = _n, Lt.isUndefined = Dn, Lt.lastIndexOf = xr, Lt.mixin = ei, Lt.noConflict = ti, 
        Lt.noop = ni, Lt.now = ri, Lt.parseInt = ii, Lt.random = oi, Lt.reduce = rr, Lt.reduceRight = ir, 
        Lt.result = ui, Lt.runInContext = Y, Lt.size = ar, Lt.some = fr, Lt.sortedIndex = Lr, 
        Lt.template = ai, Lt.unescape = li, Lt.uniqueId = ci, Lt.all = Wn, Lt.any = fr, 
        Lt.detect = Vn, Lt.findWhere = Vn, Lt.foldl = rr, Lt.foldr = ir, Lt.include = Un, 
        Lt.inject = rr, ei(function() {
            var e = {};
            return dn(Lt, function(t, n) {
                Lt.prototype[n] || (e[n] = t);
            }), e;
        }(), !1), Lt.first = gr, Lt.last = Sr, Lt.sample = or, Lt.take = gr, Lt.head = gr, 
        dn(Lt, function(e, t) {
            var n = t !== "sample";
        ...
        }), Lt.VERSION = "2.4.1", Lt.prototype.chain = di, Lt.prototype.toString = vi, Lt.prototype.value = mi, 
        Lt.prototype.valueOf = mi, Jn([ "join", "pop", "shift" ], function(e) {
            var t = nt[e];
    ...
    var M = {
        ...
        "\u2028":"u2028",
        "\u2029":"u2029"
    }, H = D[typeof window] && window || this, B = D[typeof exports] && exports && !exports.nodeType && exports, j = D[typeof module] && module && !module.nodeType && module, F = j && j.exports === B && B, I = D[typeof global] && global;
    ...
    var e = function(t) {
        var n = new e.Index();
        return n.pipeline.add(e.trimmer, e.stopWordFilter, e.stemmer), t && t.call(n, n), 
        n;
    };
    e.version = "0.5.2", e.utils = {}, e.utils.warn = function(e) {
        ...
        for (var n = t.length - 1; n >= 0; n--) if (/\S/.test(t.charAt(n))) {
            t = t.substring(0, n + 1);
            break;
        }
        ...
        t.label = n, e.Pipeline.registeredFunctions[t.label] = t;
        ...
        var t = [], n = e.length, r = this._stack.length;
        for (var i = 0; i < n; i++) {
            var s = e[i];
            for (var o = 0; o < r; o++) {
        ...
        var t = this.list, n = e.list, r = 0;
        while (t && n) t.idx < n.idx ? t = t.next :t.idx > n.idx ? n = n.next :(r += t.val * n.val, 
        t = t.next, n = n.next);
        return r;
        ...
        var t = t || 0, n = n || this.elements.length, r = n - t, i = t + Math.floor(r / 2), s = this.elements[i];
        ...
        var n = new e.SortedSet(), r = 0, i = 0, s = this.length, o = t.length, u = this.elements, a = t.elements;
        for (;;) {
        ...
        var t, n, r;
        return this.length >= e.length ? (t = this, n = e) :(t = e, n = this), r = t.clone(), 
        r.add.apply(r, n.toArray()), r;
    }, e.SortedSet.prototype.toJSON = function() {
        return this.toArray();
    }, e.Index = function() {
        this._fields = [], this._ref = "id", this.pipeline = new e.Pipeline(), this.documentStore = new e.Store(), 
        this.tokenStore = new e.TokenStore(), this.corpusTokens = new e.SortedSet(), this.eventEmitter = new e.EventEmitter(), 
        ...
        var n = new this();
        return n._fields = t.fields, n._ref = t.ref, n.documentStore = e.Store.load(t.documentStore), 
        n.tokenStore = e.TokenStore.load(t.tokenStore), n.corpusTokens = e.SortedSet.load(t.corpusTokens), 
        n.pipeline = e.Pipeline.load(t.pipeline), n;
        ...
        var r = {}, i = new e.SortedSet(), s = t[this._ref], n = n === undefined ? !0 :n;
        ...
        for (var o = 0; o < i.length; o++) {
            var u = i.elements[o], a = this._fields.reduce(function(e, t) {
        ...
        var n = e[this._ref], t = t === undefined ? !0 :t;
        ...
        var n = this.pipeline.run(e.tokenizer(t)), r = new e.Vector(), i = [], s = this._fields.reduce(function(e, t) {
            return e + t.boost;
        }, 0), o = n.some(function(e) {
            return this.tokenStore.has(e);
        }, this);
        if (!o) return [];
        n.forEach(function(t, n, o) {
            var u = 1 / o.length * this._fields.length * s, a = this, f = this.tokenStore.expand(t).reduce(function(n, i) {
                var s = a.corpusTokens.indexOf(i), o = a.idf(i), f = 1, l = new e.SortedSet();
                if (i !== t) {
        ...
        var n = this.documentStore.get(t), r = n.length, i = new e.Vector();
        for (var s = 0; s < r; s++) {
            var o = n.elements[s], u = this.tokenStore.get(o)[t].tf, a = this.idf(o);
        ...
        var e = {
            ...
            ful:"",
            ness:""
        }, n = "[^aeiou]", r = "[aeiouy]", i = n + "[^aeiouy]*", s = r + "[aeiou]*", o = "^(" + i + ")?" + s + i, u = "^(" + i + ")?" + s + i + "(" + s + ")?$", a = "^(" + i + ")?" + s + i + s + i, f = "^(" + i + ")?" + r;
        return function(n) {
            var s, l, c, h, p, d, m;
            if (n.length < 3) return n;
            c = n.substr(0, 1), c == "y" && (n = c.toUpperCase() + n.substr(1)), h = /^(.+?)(ss|i)es$/, 
            p = /^(.+?)([^s])s$/, h.test(n) ? n = n.replace(h, "$1$2") :p.test(n) && (n = n.replace(p, "$1$2")), 
            h = /^(.+?)eed$/, p = /^(.+?)(ed|ing)$/;
            if (h.test(n)) {
                var g = h.exec(n);
                ...
                var g = p.exec(n);
                s = g[1], p = new RegExp(f), p.test(s) && (n = s, p = /(at|bl|iz)$/, d = new RegExp("([^aeiouylsz])\\1$"), 
                m = new RegExp("^" + i + r + "[^aeiouwxy]$"), p.test(n) ? n += "e" :d.test(n) ? (h = /.$/, 
            ...
            return h = /ll$/, p = new RegExp(a), h.test(n) && p.test(n) && (h = /.$/, n = n.replace(h, "")), 
            c == "y" && (n = c.toLowerCase() + n.substr(1)), n;
        };
    ...
    }, e.stopWordFilter.stopWords = new e.SortedSet(), e.stopWordFilter.stopWords.length = 119, 
    ...
    e.Pipeline.registerFunction(e.stopWordFilter, "stopWordFilter"), e.trimmer = function(e) {
    ...
    var s = function(e, t) {
        ...
        t == null && (t = !0), i.$book.toggleClass("without-animation", !t), i.$book.toggleClass("with-summary", e), 
        n.set("sidebar", o());
    }, o = function() {
        ...
        r.find("li").each(function() {
            var r = e(this).data("path"), i = n == null || t.contains(n, r);
    ...
    var o = null, u = function(e) {
        ...
        i.$book.toggleClass("with-search", t), c() ? (s.toggle(!0), n.focus()) :(n.blur(), 
        n.val(""), s.filter(null));
    }, c = function() {
        ...
        a(), e(document).on("click", ".book-header .toggle-search", function(e) {
            ...
            var i = n.keyCode ? n.keyCode :n.which, o = e(this).val();
            if (i == 27) {
                n.preventDefault(), l(!1);
                return;
            }
            if (o.length == 0) s.filter(null), r.remove("keyword"); else {
                var u = f(o);
...
}), define("core/navigation", [ "jQuery", "utils/url", "core/events", "core/state", "core/progress", "core/loading", "core/search" ], function(e, t, n, r, i, s, o) {
    var u, a, f = typeof history.pushState != "undefined", l = function(n, i) {
        ...
        return s.show(e.get(u).done(function(t) {
            i && history.pushState({
                path:u
            }, null, u), t = t.replace(/<(\/?)(html|head|body)([^>]*)>/gi, function(e, t, n, r) {
                return "<" + t + "div" + (t ? "" :' data-element="' + n + '"') + r + ">";
            });
            var n = e(t), s = n.find("[data-element=head]"), a = n.find(".book"), f = s.html();
            e("head style").each(function() {
                f += this.outerHTML;
            }), e("head").html(f);
            var l = e(".book").attr("class"), c = e(".book-summary .summary").scrollTop();
            a.toggleClass("with-summary", e(".book").hasClass("with-summary")), e(".book").replaceWith(a), 
            e(".book").attr("class", l), e(".book-summary .summary").scrollTop(c), r.update(e("html")), 
            o.recover(), h();
        }).fail(function(e) {
            location.href = n;
        }));
        ...
        var t, n;
        t = parseInt(e(".body-inner").css("width"), 10), n = parseInt(e(".page-wrapper").css("width"), 10), 
        e(".navigation-next").css("margin-right", t - n + "px");
    }, h = function() {
        var t = e(".book-body"), r = t.find(".body-inner"), s = r.find(".page-wrapper");
        i.show(), c(), s.focus(), r.scrollTop(0), t.scrollTop(0), n.trigger("page.change");
    }, p = function(t) {
        ...
        e.ajaxSetup({
            ...
            return l(e.state.path, !1);
        }, e(document).on("click", ".navigation-prev", p), e(document).on("click", ".navigation-next", p), 
        e(document).on("click", ".summary [data-path] a", p), e(window).resize(c), h();
    };
    return {
        init:m,
        goNext:d,
...
}), define("gitbook", [ "jQuery", "utils/storage", "utils/sharing", "utils/dropdown", "core/events", "core/font-settings", "core/state", "core/keyboard", "core/navigation", "core/progress", "core/sidebar", "core/search" ], function(e, t, n, r, i, s, o, u, a, f, l, c) {
    var h = function(e) {
        var t;
        t = o.$book, l.init(), c.init(), u.init(), n.init(), r.init(), a.init(), s.init(e.fontSettings || {}), 
        i.trigger("start", e);
    };
    return {
        start:h,
